...
1. A completed online Generator registration form containing information related to the characteristics of the Generating Unit and associated meter.
...
a. It is helpful for generators to include a generator interconnection agreement if the generator is connected to a natural gas pipeline or a natural gas distribution network.

b. Providing any local, state, or provincial documentation or permits that can help substantiate the generator registration data. 

4. If this generator will use an IRE
